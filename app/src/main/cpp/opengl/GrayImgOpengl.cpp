...
void GrayImgOpengl::onChange(int width, int height) {
    BaseOpengl::onChange(width, height);
    glViewport(0, 0, width, height);
    setOrthoM();
}

void GrayImgOpengl::onDraw() {
...
void GrayImgOpengl::setPixel(void *data, int width, int height) {
    pixel = data;
    this->width = width;
    this->height = height;
    setOrthoM();
